        ...
        <div>
            ...
            <div className="mx-10 my-5">
                <div className="max-w-6xl mx-40 ">
                    <div className="box-content rounded-lg w-full bg-base-100 shadow-xl">
                        <figure className="px-20 pt-10">
                            <img src={service.image} alt="Shoes" className="w-full rounded-xl border border-rose-700" />
                        </figure>
                        <div className="card-body items-center text-center">
                            <h2 className="text-2xl font-semibold text-rose-500">{service.name}</h2>
                            <p className="text-base font-normal">{service.description}</p>
                            <p className="text-xl font-medium text-rose-500">Duration: {service.duration}</p>
                            <p className="text-base font-medium text-rose-500">Schedule: {service.schedule}</p>
                            <div className="card-actions">
                                <button onClick={handleJoin} className="btn text-white normal-case bg-rose-500">Join Now</button>
                            </div>
                        </div>
                    </div>
                </div>
